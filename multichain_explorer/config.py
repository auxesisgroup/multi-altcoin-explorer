...
mainnet = {
    ...
    'btc:prefix': 'http://Yourusername:Yourpassword@localhost:10332/',
...
testnet = {
    ...
    'btc_prefix': 'http://Yourusername:Yourpassword@localhost:10332/',
...
if debug is True:
    ...
    if not development:
        ...
        _set['btc_prefix'] = 'http://Yourusername:Yourpassword@localhost:10332/'
