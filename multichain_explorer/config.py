...
mainnet = {
    ...
    'btc:prefix': 'http://masscoinrpc:9Gjz8kSHqpEafq6DUaisePcnf6jSXiXcDKiUsfvwbMvC@localhost:10332/',
...
testnet = {
    ...
    'btc_prefix': 'http://masscoinrpc:9Gjz8kSHqpEafq6DUaisePcnf6jSXiXcDKiUsfvwbMvC@localhost:10332/',
...
if debug is True:
    ...
    if not development:
        ...
        _set['btc_prefix'] = 'http://masscoinrpc:9Gjz8kSHqpEafq6DUaisePcnf6jSXiXcDKiUsfvwbMvC@localhost:10332/'
